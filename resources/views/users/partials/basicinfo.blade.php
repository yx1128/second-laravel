...
<div class="box text-center">
   ...
   <div class="padding-sm user-basic-nav">
       <ul class="list-group">
             ...
             <a href="{{ route('users.mcsubscribers', $user->id) }}" class="{{ navViewActive('users.mcsubscribers') }}">
                 <li class="list-group-item"><i class="text-md fa fa-share-alt-square"></i> Ta 关注的设备</li>
             </a>
