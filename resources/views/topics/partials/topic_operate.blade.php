<div class="panel-footer operate">
  ...
  <div class="pull-right actions">
    ...
    @if (isset($is_article))
    <a id="topic-edit-button" href="{{ route('articles.edit', [$topic->id]) }}" data-content="{{ lang('Edit') }}" class="admin  popover-with-html no-pjax">
      <i class="fa fa-pencil-square-o"></i>
      @elseif (isset($is_discussion))
      <a id="topic-edit-button" href="{{ route('discussions.edit', [$topic->id]) }}" data-content="{{ lang('Edit') }}" class="admin  popover-with-html no-pjax">
        <i class="fa fa-pencil-square-o"></i>
        @else
      ...
      <a id="topic-edit-button" href="{{ isset($is_discussion) ?  route('discussions.edit', [$topic->id]) : route('topics.edit', [$topic->id]) }}" data-content="{{ lang('Edit') }}" class="admin  popover-with-html no-pjax">
        <i class="fa fa-pencil-square-o"></i>
      </a>-->
    @endif
